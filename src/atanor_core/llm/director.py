...
_SYS = (
    ...
    "- animate {{\"type\":\"animate\",\"style\":\"walk|wave|dance|rig|flow|stop\",\"ms\":3000}} "
    "moves the object with its OWN discovered skeleton: the server predicts this "
    "model's joints and each chain is role-tagged from geometry, so walk/wave/dance "
    "adapt to whatever was generated (two legs, four, wings, or none). "
    "rig=stay gently alive, flow=drift.\n"
